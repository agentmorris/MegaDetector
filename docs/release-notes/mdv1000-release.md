...
* [postprocess_batch_results](https://megadetector.readthedocs.io/en/latest/postprocessing.html#module-megadetector.postprocessing.postprocess_batch_results): the most important module in this subpackage; generates an HTML preview from a MD results file (typically sampling something like 10k images), separating images into "non-detections", "animals", etc.  The goal is to make it easy for users to grok how MD did on their data, even when ground truth isn't available.  Sample output:
  * [...when no ground truth is available](https://lila.science/public/previews/snapshot_safari_public/snapshot-safari-kar-2022-00-00-v5a.0.0_0.200/)
  * [...when ground truth is available](https://lila.science/public/previews/snapshot_safari_public/snapshot-safari_KAR_mdv5a.0.0_results.filtered_rde_0.150_0.850_15_0.200_gt)
  * [...with species classification results](https://lila.science/public/previews/speciesnet-previews/speciesnet-postprocessing-examples/caltech-camera-traps/) (in this case from [SpeciesNet](https://github.com/google/cameratrapai)) ([bonus example](https://lila.science/public/previews/speciesnet-previews/speciesnet-postprocessing-examples/idaho-camera-traps/), [other bonus example](https://lila.science/public/previews/speciesnet-previews/speciesnet-postprocessing-examples/orinoquia-camera-traps/))
