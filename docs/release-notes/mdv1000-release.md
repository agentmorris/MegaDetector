...
This is going to be more like a blog post than release notes, so, I'm getting to the punchline first... this release includes five new MegaDetector models, one the same size as MDv5 and a bit more accurate, the others - to varying degrees - faster and a bit less accurate.
...
With that out of the way, if you want to get right to the download links, visit the "[introducing MDv1000](#introducing-mdv1000)" section.  Otherwise, join me on what will be more like a blog post about the last few years of MDv5 than release notes for the new models, although I promise, we'll get there.
...
For anyone who wants to try to pick up this workflow, it's not slickly packaged, but I found it to be effective, so, ping me!
...
* All the contributors to the [ecosystem of camera trap AI tools](#ecosystem-explosion) I described earlier.  Models are fine, but no one cares about weights files; the ecosystem of tools that put models to work for conservation are where we actually benefit our users.
