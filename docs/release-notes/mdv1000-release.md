...
* [postprocess_batch_results](https://megadetector.readthedocs.io/en/latest/postprocessing.html#module-megadetector.postprocessing.postprocess_batch_results): the most important module in this subpackage; generates an HTML preview from a MD results file (typically sampling something like 10k images), separating images into "non-detections", "animals", etc.  The goal is to make it easy for users to grok how MD did on their data, even when ground truth isn't available.  Sample output:
  * [...when no ground truth is available](https://lila.science/md-preview-no-gt)
  * [...when ground truth is available](https://lila.science/md-preview-with-gt)
  * [...with species classification results](https://lilawildlife.blob.core.windows.net/lila-wildlife/previews/speciesnet-previews/speciesnet-postprocessing-examples/caltech-camera-traps/index.html) (in this case from [SpeciesNet](https://github.com/google/cameratrapai)) ([bonus example](https://lilawildlife.blob.core.windows.net/lila-wildlife/previews/speciesnet-previews/speciesnet-postprocessing-examples/idaho-camera-traps/index.html), [other bonus example](https://lilawildlife.blob.core.windows.net/lila-wildlife/previews/speciesnet-previews/speciesnet-postprocessing-examples/orinoquia-camera-traps/index.html))
