...
Permanent link to this document: <https://lila.science/megadetector-output-format>

This file describes the output format used by inference scripts in this repo, and therefore by [AddaxAI](https://addaxdatascience.com/addaxai/) and other tools that use the MegaDetector Python package.  This format is used to communicate results for MegaDetector and other AI models to downstream tools, e.g. [Timelapse](https://timelapse.ucalgary.ca/).
...
```jsonc
{
    "info": {
        ...
        // Required, must be a string-formatted float
        "format_version": "1.6",
    ...
    // for an "empty" category.  Detection category names don't have to be unique, but they
    // can't be blank.
	...
	// Classification category names don't have to be unique, but they can't be blank.
