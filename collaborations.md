...
We have somewhat-less-complete integrations with the [eMammal desktop application](https://github.com/agentmorris/MegaDetector/blob/master/api/batch_processing/integration/eMammal) and with [digiKam](https://github.com/agentmorris/MegaDetector/tree/master/api/batch_processing/integration/digiKam).
