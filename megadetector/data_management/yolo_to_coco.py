...
def main():
    """
    Command-line execution function for YOLO to COCO conversion.
    """
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='String to exclude images if found in filename. Default: None.'
    )
    parser.add_argument(
        '--include_string',
        type=str,
        default=None,
        help='String to include images only if found in filename. Default: None.'
    )
    parser.add_argument(
        '--overwrite_handling',
        type=str,
