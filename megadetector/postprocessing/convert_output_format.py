...
def convert_json_to_csv(input_path,
    ...
    Args:
        ...
        omit_bounding_boxes (bool, optional): whether to leave out the json-formatted bounding boxes
        ...
        overwrite (bool, optional): whether to overwrite an existing .csv file; if this is False and the
...
def convert_csv_to_json(input_path,output_path=None,overwrite=True):
    ...
    Args:
        ...
        output_path (str, optional): the output .json file to generate; if this is None, uses
            [input_path].json
        overwrite (bool, optional): whether to overwrite an existing .json file; if this is False and the
            output file exists, no-ops and returns
