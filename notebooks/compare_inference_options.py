...
input_folder = 'f:/data/image_folder'
test_folder_base = 'c:/temp/results_folder'
        ...
        for image_size in image_sizes:
            ...
            for augmentation_state in augmentation_states:
                ...
                for tiling_state in tiling_states:
                    ...
                    print('Job {}: {}'.format(len(all_job_info),job_name))

                    print('Processing to {}'.format(job_output_file))
