...
- `run_detector_batch.py`: runs the detector on a collection images; output format is documented [here](https://github.com/agentmorris/MegaDetector/tree/main/api/batch_processing/#batch-processing-api-output-format).
